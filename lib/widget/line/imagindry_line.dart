...
class ImaginaryLineCorner {
  ...
  ImaginaryLineCorner.all(double radius)
...
class ImaginaryLine extends StatefulWidget {
  /// 虚线颜色
  ///
  /// Dotted line color
  final Color color;
  ...
  /// 虚线边框的边角。详见 [ImaginaryLineCorner]
  ///
  /// The corners of the dotted border. See [ImaginaryLineCorner] for details
  final ImaginaryLineCorner corner;

  /// 如果设置了 [child]，[ImaginaryLine] 将会作为 [child] 的虚线边框。
  ...
  /// [ImaginaryLine] 为开发者提供了创建虚线的能力。同时支持为一个 [Widget] 创建虚线边框。支持控制虚线的粗细，间距，以及虚线边框的边角。
  ///
  /// [ImaginaryLine] provides developers with the ability to create dashed lines. It also supports creating a dashed border for a [Widget]. Support for controlling the thickness, spacing, and corners of the dotted border.
  ImaginaryLine({
    Key key,
...
class _ImaginaryLineState extends State<ImaginaryLine> {
  double childWidth;
  double childHeight;
