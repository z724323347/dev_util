...
import 'core/extended_text_selection.dart';
import 'core/extended_text_selection_overlay.dart';
import 'core/extended_text_selection_render_object.dart';
import 'extend_render_paragraph.dart';
import 'extend_rich_text.dart';
import 'extend_text_selection_pointer_handler.dart';
...
class ExtendedTextSelectionState extends State<ExtendedTextSelection>
  ...
  get _hasFocus => _effectiveFocusNode.hasFocus;
  @override
  void initState() {
  ...
  void _handleSelectionChanged(
    ...
    final longPress = cause == SelectionChangedCause.longPress;
  ...
  @override
  get copyEnabled => !textEditingValue.selection.isCollapsed;

  @override
  get cutEnabled => false;

  @override
  get pasteEnabled => false;
  ...
  @override
  void hideToolbar([hideHandles = true]) {
    if (hideHandles) {
  ...
  ///hittest
  containsPosition(Offset position) {
    //_hideSelectionOverlayIfNeeded();
